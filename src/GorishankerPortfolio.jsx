...
const TECH_LOGIC = {
  // [projectType][scale][priority] → recommendation
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#080C10", color: "#E8EDF2", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <span className="mono" style={{ fontWeight: 600, fontSize: "0.9rem", color: "#E8EDF2", letterSpacing: "0.02em" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <span
                    className="sg"
                    style={{ color: "#00C9A7", fontSize: "0.9rem", width: 20 }}
                  >
                    W
                  </span>

                  <span className="sg" style={{ fontSize: "0.875rem" }}>
                    +91 76898 64686
                  </span>
                </div>
          ...
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: "24px 28px", borderBottom: "1px solid #1A2332", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button onClick={() => setActiveProject(null)}
                style={{ background: "none", border: "none", color: "#5A6472", cursor: "pointer", fontSize: "1.2rem", lineHeight: 1 }}>✕</button>
            </div>
            ...
            <div style={{ padding: "28px" }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                <button className="cta cta-o" style={{ padding: "10px 22px", fontSize: "0.84rem" }}
                  onClick={() => { setActiveProject(null); scrollTo("Contact"); }}>
